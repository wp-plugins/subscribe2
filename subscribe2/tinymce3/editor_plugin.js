(function() {
	tinymce.create('tinymce.plugins.Subscribe2Plugin', {
		init : function(ed, url) {
			var pb = '<img src="' + url + '/img/trans.gif" class="mceSubscribe2 mceItemNoResize" />', cls = 'mceSubscribe2', sep = ed.getParam('subscribe2_separator', '<!--subscribe2-->'), pbRE;
			...
			// Register buttons
			ed.addButton('subscribe2', {title : 'Insert Subscribe2 Token', image : url + '/img/s2_button.png', cmd : cls});
