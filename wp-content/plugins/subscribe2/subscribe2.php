...
// variables and constructor are declared at the end
	...
	*/
	function load_strings() {
		...
		$this->use_profile =  __('You may manage your subscription options from your profile.', 'subscribe2') . "<br /><a href='" . get_settings('siteurl') . "/wp-admin/profile.php?page=subscribe2/subscribe2.php'>Click here to manage your subscription settings.</a>.";
