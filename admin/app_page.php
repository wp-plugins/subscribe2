...
?>
	<div class="wrap">
		...
		<p class="submit" style="border-top: none;"><a class="button-primary" href="widgets.php"><?php _e('Place Widget Now', 'subscribe2'); ?></a></p>
		...
		<p class="submit" style="border-top: none;"><a class="button-secondary" href="<?php echo admin_url('admin.php?page=s2_readygraph&app_id=0');?>"><?php _e('Unlink ReadyGraph Account', 'subscribe2'); ?></a></p>
	</div>
	...
	<div id="icon-plugins" class="icon32"></div>
		...
		<div class="register-mid" style="float: left;width:25%;">
			...
			<input type="submit" value="<?php _e('Sign In', 'subscribe2'); ?>" id="signin-submit" class="button-primary add-new-h2" name="Submit">
			</p>
			</div>
		</div>
